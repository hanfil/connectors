...
class ExportReportPdf:
    def __init__(self):
        ...
        """
        self.helper.api.opencti_stix_object_or_stix_relationship.properties = """
            ... on StixObject {
                id
                standard_id
                entity_type
    ...
    def _process_case(
        ...
        case_priority_filters = {
            "mode": "and",
            "filters": [{
                "key": ["name"],
                "values": [case_priority],
                "operator": "eq",
                "mode": "or"
            }],
            "filterGroups": []
        ...
        case_priority_desc = case_priority_object["description"].replace("|","<br>")
        # Store context for usage in html template
        context = {
            "case_name": case_name,
            ...
            "case_priority_desc": case_priority_desc,
